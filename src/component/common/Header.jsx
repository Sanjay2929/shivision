...
const Header = () => {
  return (
    <div className="xl:max-w-[1440px] xl:px-10 px-4 sm:pt-10  pt-6 mx-auto lg:pb-[110px] pb-[60px]">
      <Navbar />
      <div className="sm:h-[calc(100vh-181px)] bg-hero bg-cover sm:max-h-[600px] sm:mt-10 mt-6 bg-[80%] rounded-[40px] sm:pt-[135px] pt-[98px] pb-[98px] overflow-hidden relative">
